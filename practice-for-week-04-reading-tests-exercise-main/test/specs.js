...
// returns true if the argument is === 5.
describe("isFive(num)", () => {
...
// return true if the argument is odd and false if argument is even. Give error if argument is NaN
...
// returns array of steps from min to max. If no step argument is entered, step = 1. Return [] if min > max.
